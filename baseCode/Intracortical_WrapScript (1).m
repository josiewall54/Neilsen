...
myPath = 'C:\Users\mct519\Documents\My Files\Data Analyses\Neilsen\LFP_Analysis';
...
data_dir = [myPath '\rat_bmi-master\Data_Epidural\E1\17-07-11\'];
% data_dir = [myPath '\rat_bmi-master\Data_Intracortical\N5\17-07-10\'];
...
%%
% Converting .plx to binned neural data ----------------------------------
% Initialize variables
binSize=0.05;
sorted=0; % if you have sorted the file, sorted=1;
filename='N5_170710_noobstacle_1.plx'; % Change this to be whatever plexon filename you want
filenameKin = '17-07-11_noobstacles.csv'; % Change this to whatever kinematic filename you want
 
%Step 1: Make sure you are in the folder that contains the data you want
% Step 2. Load neural data
    ...
    %Add timeframe
    numBins = length(plexondata.channels(1).clusters(1).binneddata.spikeratedata);
    plexondata.timeframe = (0:binSize:numBins*binSize-binSize)';
    

 %% align plexon and Vicon files
 
 spikeRemoveTime = 10.5630;
 pre_indices = find(plexondata.timeframe < spikeRemoveTime);
 
plexondata.spikeratedata(pre_indices,:)=[];
plexondata.timeframe(pre_indices)=[];
...
channels = [16 17]; % Specify channels to import
% 
...
DecoderOptions.PolynomialOrder = 2;      % Order of Wiener cascade - 0 1 for linear
...
binnedData.spikeratedata=plexondata.spikeratedata;
