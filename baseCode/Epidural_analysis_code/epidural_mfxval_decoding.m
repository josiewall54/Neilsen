...
function [OLPredData, ActualData] = epidural_mfxval_decoding (binnedData, DecoderOptions)
    ...
    [mfxval_R2, mfxval_vaf, mfxval_mse, OLPredData, ActualData, mfxval_vaf_fit] = epidural_mfxvalMCT(binnedData, DecoderOptions);
    ...
    assignin('base','mfxval_vaf_fit',mfxval_vaf_fit);
