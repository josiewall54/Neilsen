...
timeframe = SelectedEMGData.timeframe;
...
save(strcat(standardFilename,'_s','.mat'),'SelectedEMGData','SelectedEMGChannelLabels','SelectedFieldData','SelectedSpikeData','timeframe','standardFilename');