...
for i = 1:length(emgdata.channel)
    emgChannelNames(emgdata.channel(i)) = deblank(allChannelNames(emgdata.channel(i) + 1,:));
end
emgdata.channelNames = emgChannelNames.values;
...
cd('/Users/josephinewallner/Desktop/LabWork/RatData/ExtractedData');
save(strcat(standardFilename,'_e','.mat'),'emgdata','spikedata','fielddata','LFPParams','standardFilename');