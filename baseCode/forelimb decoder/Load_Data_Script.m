...
[spikedata] = remove_synch_spikes(spikedata,.005,4);
...
% use for forelimb
% kinematicData.rawKinMatrix = kinematicData.rawKinMatrix(:,22:end);
kinematicData.refKinMatrix = kinematicData.rawKinMatrix;
...
LFPanalysisParams.bins = ViconSync.binedges;
