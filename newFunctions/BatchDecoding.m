...
DecoderOptions.foldlength = 37.45;          % Duration of folds (seconds) - must be multiple of 0.05
...
for fileNum=1:length(filenames)
    ...
    for j = 1:length(kinematicDataTemp)
        ...
        [PredSignal(4*(fileNum-1)+2),ActualData(4*(fileNum-1)+2)] = DecoderWrapperJ(timeframe,SelectedFieldData.data,kinematicData,DecoderOptions,labels);
