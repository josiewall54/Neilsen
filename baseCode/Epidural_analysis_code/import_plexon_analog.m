...
timeframe = 1:length(an_data.data); % these are the sample numbers
timeframe2 = an_data.timestamps(1) + (timeframe-1)/an_data.freq(1); % turn them into actual times
an_data.timeframe = timeframe2;
