...
filename = 'N5_170710_noobstacle_1'; %.plx extension not needed
filenameKin = '17-07-1001_noobstacle.csv';           %.csv extension might be needed                    
...
epi_data_ch = 48:56;    % this is fake - pretend the EMG is epidural
...
channels = [16 17 32:47 48:56]; % Specify channels to import
...
ind = find(plxVicon);
ViconOnsetSample = ind(1);  % the Plexon sample where Vicon starts
ViconOnsetTime = ViconOnsetSample/plxFreq;
...
inputdata = an_data.binnedEpiduralData.rawEpidural';  % this is the data to use to do the prediction
ninputs = size(an_data.binnedEpiduralData.rawEpidural, 1);   % the number of channels in the input
